...
RSS_FEEDS = [
    ...
    "https://news.google.com/rss/search?q=US+economy+market&hl=en-US&gl=US&ceid=US:en",
]
...
아래는 오늘의 미국 주요 경제·비즈니스 뉴스 {len(articles)}건입니다.
...
1. <h2>📊 오늘의 핵심 요약</h2> (전체 경제 동향을 3~4문장으로 요약)
2. <h2>📰 주요 뉴스</h2> (각 뉴스를 이모지와 함께 2~3문장으로 설명, <ul><li> 형식)
3. <h2>💡 오늘의 투자자 포인트</h2> (실용적인 시사점 3가지, <ol><li> 형식)
...
<head>
  ...
  <style>
    ...
    h2   {{ color:#1a237e; font-size:17px; margin-top:24px; }}
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f5;padding:20px 0;">
    <tr><td align="center">
      <table width="620" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="background:linear-gradient(135deg,#1a237e,#1565c0);
                        padding:28px 32px;text-align:center;">
          <h1 style="margin:0;color:#fff;font-size:22px;">🇺🇸 미국 경제 뉴스 브리핑</h1>
          <p style="margin:8px 0 0;color:#90caf9;font-size:14px;">
    ...
    send_html_email(f"[{mmdd}] 오늘의 미국 경제 뉴스 브리핑 🇺🇸", html)
